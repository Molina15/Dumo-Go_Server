...
public class SSL_MainClient_proves {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            keyStore.load(new FileInputStream("src/certificates/client/clientKey.jks"),"clientpass".toCharArray());
            ...
            trustedStore.load(new FileInputStream("src/certificates/client/clientTrustedCerts.jks"), "clientpass".toCharArray());
