 ...
 * @author Fx
 */
public class threadComprovadorPrestecs extends Thread {
    ...
    public threadComprovadorPrestecs(Statement stmt, ArrayList llistaPrestecs){
        this.stmt=stmt;
            ...
            try {
                ...
                while(j < llistaPrestecs.size()){
                    ...
                    try {
                        ...
                        Logger.getLogger(threadComprovadorPrestecs.class.getName()).log(Level.SEVERE, null, ex);
                    }
